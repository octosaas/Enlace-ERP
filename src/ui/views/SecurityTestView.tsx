          ...
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="rounded bg-emerald-950 border border-emerald-800 px-2 py-0.5 text-xs font-semibold text-emerald-400">
                PRD 01 A 05 • SUÍTE DE {tests.length || 28} TESTES
              </span>
            ...
            <p className="text-xs text-slate-400">
              Comprova a integridade das fronteiras de segurança entre CNPJs, bloqueio de IDOR, cálculos BRL, encargos moratórios, tesouraria e RBAC.
            </p>
          </div>
